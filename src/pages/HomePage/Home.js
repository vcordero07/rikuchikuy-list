          ...
          <div className="center-row">
            <div className="col-sm-4 col-md-4">
              <div className="block">
                ...
                <h5>Have an idea? </h5>
                <p>
                  Not a problem, add it to your list. Keep your wish list with
                  you at all times. Now you can organize and store your ideas in
                  one place. You can access your list from your mobile phone or
                  in a browser by going to "rikuchikuy-list.xyz".
                </p>
              </div>
            </div>
            <div className="col-sm-4  col-md-4">
              <div className="block">
                ...
                <p>
                  See something you want for your birthday? Add to your wish
                  list. Thinking ahead for holiday gifts? Add those to your wish
                  list as well! It’s never been easier to have all your *wishes*
                  in one place.
                </p>
              </div>
            </div>
